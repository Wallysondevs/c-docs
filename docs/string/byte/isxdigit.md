...
Verifica se o caractere fornecido é um caractere numérico hexadecimal (0123456789abcdefABCDEF) ou é classificado como um caractere hexadecimal.
...
`isdigit` e `isxdigit` são as únicas funções padrão de classificação de caracteres estreitos que não são afetadas pela localidade C atualmente instalada, embora algumas implementações (por exemplo, Microsoft na codepage 1252) possam classificar caracteres de byte único adicionais como dígitos.
...
### Referências
  ...
  * 7.4.1.12 A função isxdigit (p: 147)

  * Padrão C11 (ISO/IEC 9899:2011):

    

  * 7.4.1.12 A função isxdigit (p: 203)

  * Padrão C99 (ISO/IEC 9899:1999):

    

  * 7.4.1.12 A função isxdigit (p: 184)

  * Padrão C89/C90 (ISO/IEC 9899:1990):

    

  * 4.3.1.11 A função isxdigit
