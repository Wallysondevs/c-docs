...
```c
int iswalpha( wint_t ch );  // desde C95
```

Verifica se o caractere largo fornecido é um caractere alfabético, ou seja, uma letra maiúscula (`ABCDEFGHIJKLMNOPQRSTUVWXYZ`), uma letra minúscula (`abcdefghijklmnopqrstuvwxyz`) ou qualquer caractere alfabético específico da localidade atual.
...
Valor diferente de zero se o caractere largo for um caractere alfabético, zero caso contrário.

### Observações

[ISO 30112](<https://www.open-std.org/JTC1/SC35/WG5/docs/30112d10.pdf>) especifica quais caracteres Unicode estão incluídos na categoria POSIX alpha.
...
* TBD A função iswalpha (p: TBD)

* Padrão C17 (ISO/IEC 9899:2018):

* 7.30.2.1.2 A função iswalpha (p: 327)

* Padrão C11 (ISO/IEC 9899:2011):

* 7.30.2.1.2 A função iswalpha (p: 448-449)

* Padrão C99 (ISO/IEC 9899:1999):

* 7.25.2.1.2 A função iswalpha (p: 394-395)

### Veja também

[`isalpha`](<#/doc/string/byte/isalpha>) | verifica se um caractere é alfabético
(função)
[Documentação C++](<#/>) para iswalpha
...
`iswalpha` | [`isupper`](<#/doc/string/byte/isupper>)
