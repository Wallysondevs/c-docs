...
```c
int iswblank( wint_t ch );  // desde C99
```

Verifica se o caractere largo fornecido é classificado como caractere em branco (ou seja, um caractere de espaço em branco usado para separar palavras em uma frase) pela localidade C atual. Na localidade C padrão, apenas o espaço (`0x20`) e a tabulação horizontal (`0x09`) são caracteres em branco.
...
Valor diferente de zero se o caractere largo for um caractere em branco, zero caso contrário.

### Notas

[ISO 30112](<https://www.open-std.org/JTC1/SC35/WG5/docs/30112d10.pdf>) define os caracteres em branco POSIX como os caracteres Unicode U+0009, U+0020, U+1680, U+180E, U+2000..U+2006, U+2008, U+200A, U+205F e U+3000.
...
### Referências
  ...
  * 7.30.2.1.3 A função iswblank (p: TBD)
  ...
  * 7.30.2.1.3 A função iswblank (p: 449)

  * Padrão C99 (ISO/IEC 9899:1999):

    

  * 7.25.2.1.3 A função iswblank (p: 395)

### Veja também

[ isblank](<#/doc/string/byte/isblank>)(C99) | verifica se um caractere é um caractere em branco
(função)
