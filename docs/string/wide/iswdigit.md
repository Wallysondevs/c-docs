...
```c
int iswdigit( wint_t ch );  // desde C95
```

Verifica se o caractere largo fornecido corresponde (se estreitado) a um dos dez caracteres de dígito decimal 0123456789.
...
Valor diferente de zero se o caractere largo for um caractere numérico, zero caso contrário.

### Notas

`iswdigit` e [iswxdigit](<#/doc/string/wide/iswxdigit>) são as únicas funções padrão de classificação de caracteres largos que não são afetadas pela localidade C atualmente instalada.
...
### Referências
  ...
  * TBD 7.30.2.1.5 A função iswdigit (p: TBD)

  * Padrão C17 (ISO/IEC 9899:2018):

    

  * 7.30.2.1.5 A função iswdigit (p: 327)

  * Padrão C11 (ISO/IEC 9899:2011):

    

  * 7.30.2.1.5 A função iswdigit (p: 449)

  * Padrão C99 (ISO/IEC 9899:1999):

    

  * 7.25.2.1.5 A função iswdigit (p: 395)
