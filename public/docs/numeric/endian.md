...
Indica a [ordem de bytes](<https://en.wikipedia.org/wiki/Endianness#Overview> "enwiki:Endianness") de todos os [tipos escalares](<#/>): 
  ...
  * Os valores das expressões constantes inteiras para __STDC_ENDIAN_BIG__ e __STDC_ENDIAN_LITTLE__ não são iguais. 
