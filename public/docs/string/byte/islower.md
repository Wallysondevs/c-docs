...
Verifica se o caractere fornecido é classificado como um caractere minúsculo de acordo com a localidade C atual. Na localidade "C" padrão, `islower` retorna verdadeiro apenas para as letras minúsculas (`abcdefghijklmnopqrstuvwxyz`). 

Se `islower` retornar verdadeiro, é garantido que [iscntrl](<#/doc/string/byte/iscntrl>), [isdigit](<#/doc/string/byte/isdigit>), [ispunct](<#/doc/string/byte/ispunct>), e [isspace](<#/doc/string/byte/isspace>) retornarão falso para o mesmo caractere na mesma localidade C. 
...
### Referências
  ...
  * 7.4.1.7 A função islower (p: 146) 

  * Padrão C11 (ISO/IEC 9899:2011): 

    

  * 7.4.1.7 A função islower (p: 202) 

  * Padrão C99 (ISO/IEC 9899:1999): 

    

  * 7.4.1.7 A função islower (p: 183) 

  * Padrão C89/C90 (ISO/IEC 9899:1990): 

    

  * 4.3.1.6 A função islower 
