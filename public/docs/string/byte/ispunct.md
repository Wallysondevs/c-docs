...
Verifica se o caractere fornecido é um caractere de pontuação na locale C atual. A locale C padrão classifica os caracteres `!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~` como pontuação.
...
### Referências
  ...
  * 7.4.1.9 A função ispunct (p: 146)

  * Padrão C11 (ISO/IEC 9899:2011):

    

  * 7.4.1.9 A função ispunct (p: 202)

  * Padrão C99 (ISO/IEC 9899:1999):

    

  * 7.4.1.9 A função ispunct (p: 183)

  * Padrão C89/C90 (ISO/IEC 9899:1990):

    

  * 4.3.1.8 A função ispunct
