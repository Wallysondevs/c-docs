...
Verifica se o caractere fornecido é um caractere maiúsculo de acordo com a localidade C atual. Na localidade "C" padrão, `isupper` retorna verdadeiro apenas para as letras maiúsculas (`ABCDEFGHIJKLMNOPQRSTUVWXYZ`). 

Se `isupper` retornar verdadeiro, é garantido que [iscntrl](<#/doc/string/byte/iscntrl>), [isdigit](<#/doc/string/byte/isdigit>), [ispunct](<#/doc/string/byte/ispunct>), e [isspace](<#/doc/string/byte/isspace>) retornarão falso para o mesmo caractere na mesma localidade C. 
...
Valor diferente de zero se o caractere for uma letra maiúscula, zero caso contrário. 
...
### Referências
  ...
  * 7.4.1.11 A função isupper (p: 147) 

  * Padrão C11 (ISO/IEC 9899:2011): 

    

  * 7.4.1.11 A função isupper (p: 203) 

  * Padrão C99 (ISO/IEC 9899:1999): 

    

  * 7.4.1.11 A função isupper (p: 184) 

  * Padrão C89/C90 (ISO/IEC 9899:1990): 

    

  * 4.3.1.10 A função isupper 

### Veja também

[ iswupper](<#/doc/string/wide/iswupper>)(C95) |  verifica se um caractere largo é um caractere maiúsculo   
(função)  
[C++ documentation](<#/>) para isupper  
...
[`iswalpha`](<#/doc/string/wide/iswalpha>) |  `isupper`  
