...
```c
int iswgraph( wint_t ch );  // desde C95
```

Verifica se o caractere largo fornecido possui uma representação gráfica, ou seja, se é um número (`0123456789`), uma letra maiúscula (`ABCDEFGHIJKLMNOPQRSTUVWXYZ`), uma letra minúscula (`abcdefghijklmnopqrstuvwxyz`), um caractere de pontuação (`!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~`) ou qualquer caractere gráfico específico da localidade C atual.
...
* Padrão C23 (ISO/IEC 9899:2024):
  ...
  * 7.30.2.1.6 A função iswgraph (p: TBD)
...
* Padrão C11 (ISO/IEC 9899:2011):
  ...
  * 7.30.2.1.6 A função iswgraph (p: 449-450)

* Padrão C99 (ISO/IEC 9899:1999):

  * 7.25.2.1.6 A função iswgraph (p: 395-396)
