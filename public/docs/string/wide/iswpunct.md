...
Verifica se o caractere largo fornecido é um caractere de pontuação, ou seja, se é um dos `!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~` ou qualquer caractere de pontuação específico da localidade atual.
...
Valor diferente de zero se o caractere largo for um caractere de pontuação, zero caso contrário.

### Observações

[ISO 30112](<https://www.open-std.org/JTC1/SC35/WG5/docs/30112d10.pdf>) especifica quais caracteres Unicode estão incluídos na categoria POSIX punct.
...
### Referências
  ...
  * 7.30.2.1.9 A função iswpunct (p: TBD)
  ...
  * 7.30.2.1.9 A função iswpunct (p: 450)

  * Padrão C99 (ISO/IEC 9899:1999):

    

  * 7.25.2.1.9 A função iswpunct (p: 396)

### Veja também

[ ispunct](<#/doc/string/byte/ispunct>) | verifica se um caractere é um caractere de pontuação
(função)
[Documentação C++](<#/>) para iswpunct
...
`iswpunct` | [`isalnum`](<#/doc/string/byte/isalnum>)
