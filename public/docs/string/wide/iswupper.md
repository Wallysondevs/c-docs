...
```c
int iswupper( wint_t ch );  // desde C95
```

Verifica se o caractere largo fornecido é uma letra maiúscula, ou seja, uma das `ABCDEFGHIJKLMNOPQRSTUVWXYZ` ou qualquer letra maiúscula específica da localidade atual.
...
Valor diferente de zero se o caractere largo for uma letra maiúscula, zero caso contrário.
...
### Referências
  ...
  * 7.30.2.1.11 A função iswupper (p: TBD)
  ...
  * 7.30.2.1.11 A função iswupper (p: 451)

  * padrão C99 (ISO/IEC 9899:1999):

    

  * 7.25.2.1.11 A função iswupper (p: 397)
