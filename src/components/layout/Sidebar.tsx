      ...
      >
        ...
        >
          <Link href="/" onClick={() => setIsOpen(false)} className="flex items-center gap-3 min-w-0">
            <span className="w-7 h-7 flex items-center justify-center rounded bg-[hsl(var(--nix-blue))]/15 font-mono font-bold text-[hsl(var(--nix-blue))] flex-shrink-0">C</span>
            <div className="min-w-0">
              <h1 className="font-mono font-bold text-sm text-[hsl(var(--nix-blue))] leading-tight">C Reference</h1>
              <p className="text-[10px] text-[hsl(var(--nix-dim))] font-mono leading-tight">cppreference — PT-BR</p>
            </div>
          </Link>
          <button
